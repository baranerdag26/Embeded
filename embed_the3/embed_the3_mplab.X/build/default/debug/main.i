...
unsigned char button3_state = 0;
unsigned char button4_state = 0;
...
void initButtons(void)
{
    ...
    LATDbits.LATD0 = 0; LATCbits.LATC0 = 0; LATBbits.LATB0 = 0; LATAbits.LATA0 = 0;;
    LATB = PORTB;
    TRISDbits.TRISD0 = 0;
    TRISCbits.TRISC0 = 0;
    TRISBbits.TRISB0 = 0;
...
void __attribute__((picinterrupt(("")))) ISR(void)
{
    ...
    if (INTCONbits.RBIF)
    {
        ...
        if (manual_control)
        {
            ...
            if (PORTBbits.RB4 == 1 && button1_state == 0)
            {
                button1_state = 1;
            }
            else if (PORTBbits.RB4 == 0 && button1_state == 1)
            {
                button1_state = 0;
                sendUSART("$PRS04#");
            }
            ...
            if (PORTBbits.RB5 == 1 && button2_state == 0)
            {
                button2_state = 1;
            }
            else if (PORTBbits.RB5 == 0 && button2_state == 1)
            {
                button2_state = 0;
                sendUSART("$PRS05#");
            }
            ...
            if (PORTBbits.RB6 == 1 && button3_state == 0)
            {
                button3_state = 1;
            }
            else if (PORTBbits.RB6 == 0 && button3_state == 1)
            {
                button3_state = 0;
                sendUSART("$PRS06#");
            }
            ...
            if (PORTBbits.RB7 == 1 && button4_state == 0)
            {
                button4_state = 1;
            }
            else if (PORTBbits.RB7 == 0 && button4_state == 1)
            {
                button4_state = 0;
                sendUSART("$PRS07#");
            }
