...
void __attribute__((picinterrupt(("")))) ISR(void)
{
    ...
    if (INTCONbits.RBIF)
    {
        ...
        if (manual_control)
        {
            ...
            if (PORTBbits.RB4 == 0 && button1_state == 0)
            {
                button1_state = 1;
            }
            else if (PORTBbits.RB4 == 1 && button1_state == 1)
            {
                button1_state = 0;
                prs4_flag = 1;
                LATDbits.LATD0 = 0;
            ...
            if (PORTBbits.RB5 == 0 && button2_state == 0)
            {
                button2_state = 1;
            }
            else if (PORTBbits.RB5 == 1 && button2_state == 1)
            {
                button2_state = 0;
                prs5_flag = 1;
                LATCbits.LATC0 = 0;
            ...
            if (PORTBbits.RB6 == 0 && button3_state == 0)
            {
                button3_state = 1;
            }
            else if (PORTBbits.RB6 == 1 && button3_state == 1)
            {
                button3_state = 0;
                prs6_flag = 1;
                LATBbits.LATB0 = 0;
            ...
            if (PORTBbits.RB7 == 0 && button4_state == 0)
            {
                button4_state = 1;
            }
            else if (PORTBbits.RB7 == 1 && button4_state == 1)
            {
                button4_state = 0;
                prs7_flag = 1;
                LATAbits.LATA0 = 0;
